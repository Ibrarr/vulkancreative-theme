...
$cs_order  = wp_list_pluck( vc_ordered_services(), 'term_id' );
usort( $cs_terms, function ( $a, $b ) use ( $cs_order ) {
	$ai = array_search( $a->term_id, $cs_order, true );
	$bi = array_search( $b->term_id, $cs_order, true );
