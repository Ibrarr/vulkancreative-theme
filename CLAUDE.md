...
- **Case studies (17 Sep 2026):** four real case studies are live locally and paired to their work entries (The Boundary SW6, Source Pay, Minds Behind the Bite, Bite Talent), built on the clients' own report figures. The homepage three are The Boundary, Source Pay and Bite Talent; the podcast is not featured, so Bite does not appear twice. Three more (Leigh Blanks, Now Sold, The Broker House) wait on real figures in the content repo's `held/case-studies/`. Case study images are centre-safe wall boards, a different recipe from the work boards: see `docs/case-studies-system.md`. The launch copies the local database, so there is nothing to replay.
